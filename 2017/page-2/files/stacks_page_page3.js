...
stacks.stacks_in_17_page3 = {};
stacks.stacks_in_17_page3 = (function(stack) {
...
function keepPage(){
  var thisSF3H = $('#stacks_in_17_page3-sf').find('.slider');
  thisSF3H.appear();
...
function initSF3(){
  var thisSF3 = $('#stacks_in_17_page3-sf');
  ...
  if(sfThumbs >= 1 && 0 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_17_page3-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_17_page3-sf .carousel"
    });
  }else{
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_17_page3-sf');
}
...
return stack;})(stacks.stacks_in_17_page3);